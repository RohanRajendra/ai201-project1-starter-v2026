...
All 5 of 5 sampled chunks must be hierarchical. That is each one begins with its source document's title line, above the body text. Checked by comparing a chunk's first line to the first line of its named file in corpora/campus_life/documents/ must match. 
